...
.. |python| image:: https://img.shields.io/pypi/pyversions/ansys-scade-ps?logo=pypi
   :target: https://pypi.org/project/ansys-scade-ps/
   :alt: Python

.. |pypi| image:: https://img.shields.io/pypi/v/ansys-scade-ps.svg?logo=python&logoColor=white
   :target: https://pypi.org/project/ansys-scade-ps
   :alt: PyPI
...
.. |doc| image:: https://img.shields.io/badge/docs-ps-green.svg?style=flat
   :target: https://ps.scade.docs.pyansys.com
   :alt: Doc
...
see `Getting started <https://ps.scade.docs.pyansys.com/version/stable/getting-started/index.html>`_.
To install for development, see `Contribute <https://ps.scade.docs.pyansys.com/version/stable/contributing.html>`_.

Documentation and issues
------------------------
Documentation for the latest stable release of Ansys SCADE Power Scripts is hosted at
`Ansys SCADE Power Scripts documentation <https://ps.scade.docs.pyansys.com/>`_.
